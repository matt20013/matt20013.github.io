...
d3.json('../data/assaynet_matched_interventions.json').then(function (experiments) {
  ...
  var interventionTableDimension = ndx_int.dimension(function (d) { return [d.iname]; });
  ...
  interventionTable /* dc_datatables.datatable('.dc-data-table') */
    ...
    //'has_assays','name', 'has_clinical_trials', 'in_als_untangled', 'assay_classification_types', 'trial_links_new', 'tags'
